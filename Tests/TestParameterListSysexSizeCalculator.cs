...
public class ParameterListSysexSizeCalculatorTests
{
    ...
    public void TestSizeWithoutDataDep()
    {
        List<Integra7ParameterSpec> l = new List<Integra7ParameterSpec>() {
            new(type:NUM, path:"Studio Set Common Chorus/Chorus Type", offs:[0x00, 0x00], imin:0, imax:3, omin:0, omax:3, bytes:1, res:USED, nib:false, unit:"", repr:CHORUS_TYPE, isparent:true),
    ...
    public void TestSizeWithDataDepInMiddle()
    {
        List<Integra7ParameterSpec> l = new List<Integra7ParameterSpec>() {
            ...
            new(type:NUM, path:"Studio Set Common Chorus/Reserved", offs:[0x00, 0x02], imin:0, imax:3, omin:0, omax:3, bytes:1, res:RESERVED, nib:false, unit:"", repr:null),
            new(type:NUM, path:"Studio Set Common Chorus/Chorus Output Select", offs:[0x00, 0x03], imin:0, imax:2, omin:0, omax:2, bytes:1, res:USED, nib:false, unit:"", repr:MAIN_REV),
            new(type:NUM, path:"Studio Set Common Chorus/Chorus Parameter 1/Reserved", offs:[0x00, 0x04], imin:12768, imax:52768, omin:-20000, omax:20000, bytes:4, res:RESERVED, nib:true, unit:"", repr:null, par:"Studio Set Common Chorus/Chorus Type", parval:CHORUS_TYPE[0]),
            new(type:NUM, path:"Studio Set Common Chorus/Chorus Parameter 1/Filter Type", offs:[0x00, 0x04], imin:0, imax:2, omin:0, omax:2, bytes:4, res:USED, nib:true, unit:"", repr:OFF_LPF_HPF, par:"Studio Set Common Chorus/Chorus Type", parval:CHORUS_TYPE[1]),
            new(type:NUM, path:"Studio Set Common Chorus/Chorus Parameter 1/Delay Left", offs:[0x00, 0x04], imin:0, imax:1, omin:0, omax:1, bytes:4, res:USED, nib:true, unit:"", repr:DELAY_MSEC_NOTE, par:"Studio Set Common Chorus/Chorus Type", parval:CHORUS_TYPE[2]),
            new(type:NUM, path:"Studio Set Common Chorus/Chorus Parameter 1/Pre-LPF", offs:[0x00, 0x04], imin:0, imax:7, omin:0, omax:7, bytes:4, res:USED, nib:true, unit:"", repr:null, par:"Studio Set Common Chorus/Chorus Type", parval:CHORUS_TYPE[3]),
