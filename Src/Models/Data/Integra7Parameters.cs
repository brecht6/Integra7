...
public class Integra7Parameters
{
    ...
    public Integra7Parameters()
    {
        ...
        _parameters = new List<Integra7ParameterSpec>
        {
            ...
            new(type:ASC, path:"SuperNATURAL Synth Tone Common/Kit Name", offs:[0x00, 0x00], imin:32, imax:127, omin:32, omax:127, bytes:12, vis:USED, nib:false, repr:null),
            new(type:NUM, path:"SuperNATURAL Synth Tone Common/Kit Level", offs:[0x00, 0x0c], imin:0, imax:127, omin:0, omax:127, bytes:1, vis:USED, nib:false, repr:null),
